...
try
    ...
    plot(r_saturn_traj(1, :), r_saturn_traj(2, :), 'm--', 'LineWidth', 1.2, 'DisplayName', 'Orbita Saturno');
    
    
    % Punti chiave
    plot(r_sat_marsfb_sp(1), r_sat_marsfb_sp(2), 'ro', 'MarkerFaceColor', 'r', 'DisplayName', 'Uscita SOI Terra');
    ...
    plot(r_mars_sp(1), r_mars_sp(2), 'bo', 'MarkerFaceColor', 'b', 'DisplayName', 'Marte (alla partenza)');
    %plot(r_mars_traj(1, 1), r_mars_traj(2, 1), 'mo', 'MarkerFaceColor', 'w', 'DisplayName', 'Marte (Start)');
    plot(r_saturn_arr(1), r_saturn_arr(2), 'mo', 'MarkerFaceColor', 'm', 'DisplayName', 'Saturno (arrivo)');
    ...
    plot(r_saturn_arr(1) + saturn_soi_au*cos(theta), r_saturn_arr(2) + saturn_soi_au*sin(theta), 'b--', 'DisplayName', 'SOI Terra (proj)');
    ...
    try
        ...
        quiver(r_mars_sp(1), r_mars_sp(2), v_mars_vec(1), v_mars_vec(2), 0, 'b', 'LineWidth', 1.4, 'MaxHeadSize', 0.5);
        quiver(r_saturn_arr(1), r_saturn_arr(2), v_saturn_vec(1), v_saturn_vec(2), 0, 'm', 'LineWidth', 1.4, 'MaxHeadSize', 0.5);
