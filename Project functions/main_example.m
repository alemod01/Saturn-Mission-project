...
t_interp = jd_vec_planets*24*60*60;
...
[r_ecl, v_ecl] = eci_eq2ecl(r_eq, v_eq);
...
v_earth_sp_appr = v_earth_sp_appr';
v_mars_sa_appr = v_mars_sa_appr';
...
% -----------------------------------------------------------------------------------------------------------------------------------------------------
%% Part 1: Escape manoeuver from Earth
...
theta_f = pi + acos(1/sat.orbit_escape_earth.e);
